...
from trainer_fundus import trainer_fundus
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'fundus': {
            'root_path': '<Your dataset parent folder>/fundus/',
            'list_dir': None,
            'gen_image_dir':'<Your controlnet parent folder>/ControlNet/fundus_gen_16',
            'num_classes': 2,
        },
    }
    ...
    args.gen_image_dir = dataset_config[dataset_name]['gen_image_dir'] if args.gen_image else None
